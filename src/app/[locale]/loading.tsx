...
/**
 * Route-level loading state. ADR-004 makes streaming architectural rather than decorative: with
 * Cache Components, a component that reads cookies must stream, so *loading* is a state the
 * framework requires you to design.
 */
