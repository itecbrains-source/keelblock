...
**2026-09-17 — `stripe` removed, by its own expiry condition arriving.** Its row said "Declared
ahead of SPEC-007 (billing) … Removed when: SPEC-007". SPEC-007's webhook now imports it, so the
claim that it was not dead YET stopped being a claim. The `unused` gate reported the expiry on the
first run after the import landed, which is the mechanism F-68 added doing exactly what it was for —
the previous five expiries had to be found by hand.
